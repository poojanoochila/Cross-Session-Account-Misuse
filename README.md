...
This case study documents an incident of unauthorized account use resulting from session persistence on a shared college laboratory system. A student unknowingly accessed another user's ChatGPT account because an active session was left open on a shared machine.
